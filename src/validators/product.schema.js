...
const createProductSchema = z
    .object({
        ...
        discountedPrice: z.number().min(0, "Discounted price must be ≥ 0").nullable().optional(),
    ...
    .refine(
        (data) => data.discountedPrice == null || data.discountedPrice < data.price,
        { message: "Discounted price must be less than actual price", path: ["discountedPrice"] }
    );
